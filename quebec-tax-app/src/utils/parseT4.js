export const T4_FIELD_LABELS = {
  ...
  box24: { label: 'EI insurable earnings',           box: '24',  description: 'Total insurable earnings subject to EI premiums', isNumeric: true },
  box26: { label: 'CPP/QPP pensionable earnings',    box: '26',  description: 'Total pensionable earnings for CPP/QPP purposes', isNumeric: true },
  ...
  box45: { label: 'Employer-offered dental benefits', box: '45', description: 'Code indicating dental coverage offered: 1 = no coverage, 2 = self only, 3 = self and family/dependants', isNumeric: true, isCurrency: false },
  box46: { label: 'Charitable Donations',            box: '46',  description: 'Donations made through payroll deduction', isNumeric: true },
  box48: { label: 'Other Taxable Benefits',          box: '48',  description: 'Other taxable employment benefits included in income', isNumeric: true },
